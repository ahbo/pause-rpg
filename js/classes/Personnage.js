...
Personnage.prototype.dessinerPersonnage = function(context) {
	...
	if(this.etatAnimation >= DUREE_DEPLACEMENT) {
		...
		this.etatAnimation++;
		sessionStorage.setItem('SENS',this.direction);
	}
	/*
...
Personnage.prototype.deplacer = function(direction, map) {
	...
	// Calcul du taux de probabilité de Mobs
	var Mobs = Math.floor((Math.random() * 100) + 1);
	console.log(Mobs);

	//switch vers la page de combat si MOBS >= (), recuperation Coord-Position
	if (Mobs >= 80) {
		console.log("MOBS");
		// Switch vers la page de combats.
		top.location = "combat.html";
		console.log();
	} else {
